package com.example.learn.z_other.EnumResearch;
...
public enum NewsCategoryEnum {
    ...
    //（攻略-功能）
    HOME_ACCEPT(1001, "收纳"),
    HOME_VENTILATE(1002, "通风"),
    HOME_AIR_CONDITION(1003, "空调"),
    HOME_LIGHTING(1004, "照明"),
    HOME_HEATING(1005, "采暖"),
    HOME_FEED_WATER(1006, "上水"),
    HOME_DRAIN_WATER(1007, "排水"),
    HOME_FURRED_CEILING(1008, "吊顶"),
    // （攻略-产品）
    HOME_BATHROOM(1101, "卫浴"),
    HOME_WARDROBE(1102, "衣柜"),
    HOME_KTICHEN(1103, "厨房"),
    HOME_HOUSEHOLD(1104, "家电"),
    HOME_FURNITURE(1105, "家具"),
    HOME_FLOOR(1106, "地板"),
    HOME_CEILWALL(1107, "顶墙"),
    HOME_DOOR_WINDOW(1108, "五金门窗"),
    HOME_WATERPROOF(1109, "防水"),
    HOME_AUXILIARY_MATERIAL(1110, "辅材"),
    HOME_DECORATION(1111, "装饰"),
    HOME_CERAMIC_TILE(1112, "瓷砖"),
    //（资讯-新增）
    HOME_INDUSTRY_FOCUS(1201, "行业聚焦"),
    HOME_CORPORATE_NEWS(1202, "企业新闻"),
    HOME_DEEP_VIEW(1203, "深度观点"),
